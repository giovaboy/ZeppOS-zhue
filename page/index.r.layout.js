    ...
    switch (currentState) {
        ...
        case 'BT_ERROR':
            ...
            pageContext.createTrackedWidget(widget.TEXT, {
                ...
                h: px(60),
                text: getText('BT_NOT_CONNECTED') || 'Bluetooth Disconnected',
                text_size: px(26),
                color: COLORS.error,
                align_h: align.CENTER_H,
                align_v: align.CENTER_V
            ...
            pageContext.createTrackedWidget(widget.TEXT, {
                ...
                h: px(100),
                text: getText('BT_CONNECT_INSTRUCTIONS') || 'Please connect your watch\nto your phone via Bluetooth\nand try again',
                text_size: px(20),
            ...
            pageContext.createTrackedWidget(widget.TEXT, {
                ...
                w: DEVICE_WIDTH - px(60),
                h: px(60),
                text: getText('BT_AUTO_RETRY') || 'Checking connection...',
                text_size: px(16),
                color: COLORS.textSecondary,
                align_h: align.CENTER_H,
                align_v: align.CENTER_V
